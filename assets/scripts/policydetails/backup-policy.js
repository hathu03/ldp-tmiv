jQuery(document).ready(function () {
    ...
    if (width <= 768) {
        ...
        <div class="form_group_mobile">
            <div class="gender">
                ...
                <select required name="additionalinsured[${indexMobile}][gender]">
                    <option value=""></option>
                    <option value="male">${l10n.getText('Male')}</option>
                    <option value="female">${l10n.getText('Female')}</option>
                </select>
            </div>
        ...
        $("#form_submit_detail_mobile .check").find("#checkbox").on('change', function () {
            ...
            if ($(this).is(':checked')) {
                ...
                trInsurendMain.find(`input[name='additionalinsured[${x}][insuredName]`).val($('.full_name').val());
                trInsurendMain.find(`input[name='additionalinsured[${x}][dateOfBirth]`).val($('.date-picker').val());
                // trInsurendMain.find('.custom-phone').text($('.date-picker').val());
                trInsurendMain.find(`input[name='additionalinsured[${x}][insuredIDNumber]`).val($('.id_citizenship').val());
                trInsurendMain.find(`select[name='additionalinsured[${x}][gender]`).val($('#gender_insurend').val());
                trInsurendMain.find(`select[name='additionalinsured[${x}][nationality]`).val($('#insurend_nationality').val());
                trInsurendMain.find(`select[name='additionalinsured[${x}][relationship]`).val('Self');

                $(".full_name").keyup(function () {
                    ipKeyupM($(this).val(), `input[name='additionalinsured[${x}][insuredName]`);
                })

                $(".id_citizenship").keyup(function () {
                    ipKeyupM($(this).val(), `input[name='additionalinsured[${x}][insuredIDNumber]`);
                })

                $("#gender_insurend").change(function () {
                    ipKeyupM($(this).val(), `select[name='additionalinsured[${x}][gender]`);
                });

                $("#insurend_nationality").change(function () {
                    ipKeyupM($(this).val(), `select[name='additionalinsured[${x}][nationality]`);
                });
                ...
                trInsurendMain.find(`select[name='additionalinsured[${x}][relationship]`).val('');
                trInsurendMain.find(".custom-phone").text('')
                trInsurendMain.find(`input[name='additionalinsured[${x}][dateOfBirth]`).val('');

                $(`input[name='additionalinsured[${x}][insuredName]`).val("");
                $(`input[name='additionalinsured[${x}][insuredIDNumber]`).val("");
                $(`select[name='additionalinsured[${x}][gender]`).val("");
                $(`select[name='additionalinsured[${x}][nationality]`).val("");
        ...
        // Check xem co phai la nguoi lam bao hiem khong , se tu dong xoa 1 cot khi tich vao


        // $("#form_submit_detail .check").find("#checkbox").on('change', function () {
        //     if ($(".check #checkbox").is(":checked") == true) {
        //         $("._dom-out").html("");
        //         $('.content_table').find('#insurend_main').appendTo("._dom-out");
        //         $(".table.adults table tbody").find("input").not(".relationship_hd").val("");
        //         $(".table.adults table tbody").find("label").text("");
        //         $(".table.adults table tbody").find("select").val("");
        //         $(".table.adults table tbody").find("p").text("");
        //         $(".table.adults table tbody").find(".cmnd_adults_").prop("disabled", false);
        //         $(".table.adults table tbody").find(".cmnd").removeClass("is-active");
        //         $("#msg_confirm").addClass('is-active');
        //         // return false;
        //     } else {
        //         $("#msg_confirm").removeClass('is-active');
        //         $trLast = $(".table.adults table tbody tr:last");
        //         $("._dom-out tr").find("input").not(".relationship_hd").val("");
        //         $("._dom-out tr").find("select").val("");
        //         $("._dom-out tr").find("label").text("");
        //         $("._dom-out tr").find("p").text("");
        //         $("._dom-out tr").find(".cmnd_adults_").prop("disabled", false);
        //         $("._dom-out tr").find(".cmnd").removeClass("is-active");
        //         $trNew = $("._dom-out tr").appendTo($(".adults .content_table tbody"));
        //         $trLast.after($trNew);
    ...
    $("#form_submit_detail .check").find("#checkbox").on('change', function () {
        ...
        if ($(this).is(':checked')) {
            ...
            trInsurendMain.find('.custom-phone').text($('.date-picker').val());
            trInsurendMain.find(`input[name='additionalinsured[${x}][insuredIDNumber]`).val($('.id_citizenship').val());
            trInsurendMain.find(`select[name='additionalinsured[${x}][gender]`).val($('.gender').val());
            trInsurendMain.find(`select[name='additionalinsured[${x}][nationality]`).val($('#insurend_nationality').val());
            trInsurendMain.find(`select[name='additionalinsured[${x}][relationship]`).val('Self');

            $("#full_name").keyup(function () {
                inputKeyUp($(this).val(), `input[name='additionalinsured[${x}][insuredName]`);
            })

            $(".id_citizenship").keyup(function () {
                inputKeyUp($(this).val(), `input[name='additionalinsured[${x}][insuredIDNumber]`);
            })

            $(".gender").change(function () {
                inputKeyUp($(this).val(), `select[name='additionalinsured[${x}][gender]`);
            });

            $("#insurend_nationality").change(function () {
                inputKeyUp($(this).val(), `select[name='additionalinsured[${x}][nationality]`);
            });
    ...
    $('input[class="date-picker"]').on('apply.daterangepicker', function (ev, picker) {
        ...
        if (checkInsurend.is(":checked")) {
            ...
            $(".table.adults #insurend_main").find(`input[name='additionalinsured[${number_tr_adults_}][dateOfBirth]`).val($(this).val());
        }
