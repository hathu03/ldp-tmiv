		...
		<div style="display: flex; flex-grow: 1; flex-wrap: wrap; margin-bottom: -2.5rem;" class="left-side">
			<div style="padding-left: 1rem; padding-right: 1rem;" class="left-side-each-box">
				...
				<nav style="list-style-type: none; margin-bottom: 2.5rem; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity));">
					<ul>
						<li>
							<p>Lửng 01, tầng lửng, Tòa nhà Trung tâm tài chính Bảo Việt, 233 Đồng Khởi, P. Bến Nghé, Quận 1</p>
						</li>
						<li>
							<span>Điện thoại:</span> <a href="tel:02873012939" title="028-7301-2939">028-7301-2939</a>
						</li>
						<li>
							<span>Email:</span> <a href="mailto:sgn.obvn@songhantourist.com" title="sgn.obvn@songhantourist.com">sgn.obvn@songhantourist.com</a>
						</li>
					</ul>
				</nav>
			</div>
			<div style="padding-left: 1rem; padding-right: 1rem;" class="left-side-each-box">
				...
				<nav style="list-style-type: none; margin-bottom: 2.5rem; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity));">
					<ul>
						<li>
							<p>Tầng 10, Tòa nhà Hồng Hà Center, 25 Lý Thường Kiệt, Hoàn Kiếm, Hà Nội</p>
						</li>
						<li>
							<span>Điện thoại:</span> <a href="tel:02473001700" title="024-7300-1700">024-7300-1700</a>
						</li>
						<li>
							<span>Email:</span> <a href="mailto:han.obvn@songhantourist.com" title="han.obvn@songhantourist.com">han.obvn@songhantourist.com</a>
						</li>
					</ul>
				</nav>
			</div>
